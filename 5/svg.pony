...
class val PathBezCubicR
  ...
  fun render(): String =>
    "".join([_command; " "; _x2; ","; _y2; " "; _x; ","; _y].values())

class val PathBezQuad
  let _command: String
  let _x1: F64
  let _y1: F64
  let _x: F64
...
class PathCommands
  let _command_list: Array[PathCommand] = _command_list.create()
